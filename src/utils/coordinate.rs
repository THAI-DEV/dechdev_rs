pub fn coordinate_index_all(
    ...
    let mut temp_col = column_index as i32 + 1;
...
pub fn coordinate_index_left(row_index: usize, column_index: usize) -> (i32, i32) {
    //* Left
    let temp_row = row_index as i32;
    let mut temp_col = column_index as i32 - 1;
    if temp_col < 0 {
...
pub fn coordination_index_down(
    ...
    //* Down
    let mut temp_row = row_index as i32 + 1;
...
pub fn coordination_index_up(row_index: usize, column_index: usize) -> (i32, i32) {
    //* Up
    let mut temp_row = row_index as i32 - 1;
    let temp_col = column_index as i32;
    if temp_row < 0 {
...
pub fn coordination_index_left_up(row_index: usize, column_index: usize) -> (i32, i32) {
    //* Left Up
    let mut temp_row = row_index as i32 - 1;
    let mut temp_col = column_index as i32 - 1;
    if temp_row < 0 || temp_col < 0 {
